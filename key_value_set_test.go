...
func Test_Intersects(t *testing.T) {
	t.Run("intersects", func(t *testing.T) {
		set1 := newKV(testKeyer, 1, 2)
		set2 := newKV(testKeyer, 2, 3)
...
func Test_Equal(t *testing.T) {
	t.Run("equal", func(t *testing.T) {
		set1 := newKV(testKeyer, 1, 2)
		set2 := newKV(testKeyer, 2, 1)

		assert.True(t, set1.Equal(set2))
	})

	t.Run("not equal", func(t *testing.T) {
		set1 := newKV(testKeyer, 1, 2, 3)
		set2 := newKV(testKeyer, 2, 1)
...
func Test_Subset(t *testing.T) {
	set1 := newKV(testKeyer, 1, 2, 3, 4)
	subset1 := newKV(testKeyer, 1, 4)
